...
const BasicForm = (props) => {
  const {
    value: firstNameValue, // we need alias "firstNameValue" bcs we're using key value 3 times
  ...
  const {
    value: emailValue, // we need alias "firstNameValue" bcs we're using key value 3 times
